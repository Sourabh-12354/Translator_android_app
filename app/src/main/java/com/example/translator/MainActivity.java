...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From","English","Afrikaans","Arabic","Bengali","Hindi","Urdu","Welsh"};
    String[] toLanguages = {"To","English","Afrikaans","Arabic","Bengali","Hindi","Urdu","Welsh"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sourceEdt = findViewById(R.id.idEdtSrc);
        micIV = findViewById(R.id.idIVMIC);
        translateBtn = findViewById(R.id.idBtnTranslate);
        translatedTV =findViewById(R.id.txtviewtranslated);
    ...
    private void translateText(int fromLanguageCode, int toLanguageCode, String source)
    {
        ...
        translator.downloadModelIfNeeded(conditions).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                translatedTV.setText("Translatting....");
